...
def apply_clustering(bindingdb_dataset, num_of_clusters, cluster_type='k_means'):
    ...
    if cluster_type == 'agglomerative':
        bindingdb_dataset = Agglomerative(bindingdb_dataset, 'fp', num_of_clusters).cluster()
...
def main():
    ...
    bindingdb_dataset = apply_clustering(bindingdb_dataset, cluster_type='agglomerative')
